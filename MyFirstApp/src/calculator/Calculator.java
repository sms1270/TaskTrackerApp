...
public class Calculator {
	...
	public static int calculateDifference(int a_difference, int b_difference) {
		int total_difference = b_difference - a_difference;
		System.out.println("The difference is " + total_difference);
		return 0;
		}
	
	public static int calculateProduct(int a_product, int b_product) {
		int total_product = b_product * a_product;
		System.out.println("The product is " + total_product);
		return 0;
		}
		
	public static int calculateDivision(int a_division, int b_division) {
