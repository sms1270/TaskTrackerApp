...
<!--This is button that goes to create task screen -->
		...
		<a href="${contextPath}/addTaskView"
						class="btn btn-primary btn-xs pull-right"><b>+</b> Add a new
						task</a>
						
<!--This is button that goes to assign task screen -->
		<div class="row col-lg-6 col-md-offset-2 custyle">
		<a href="${contextPath}/assignTask"
						class="btn btn-primary btn-xs pull-left"><b>+</b> Assign a task to 
							a new user</a>
